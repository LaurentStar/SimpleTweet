...
<img src='https://github.com/LaurentStar/SimpleTweet/blob/master/walk_through2.gif?raw=true' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
# Project 2 - *Simple APP

**Simple APP** is an android app that allows a user to view his Twitter timeline. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
